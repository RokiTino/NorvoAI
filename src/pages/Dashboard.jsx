...
const Dashboard = ({ session, onNavigate, onSignOut }) => {
  ...
  const syncJira = useSyncJiraIssues();
  const syncNotion = useSyncNotionPages();
  ...
  const handleSyncJira = async () => {
    ...
    try {
      const result = await syncJira.mutateAsync(workspaceId);
      alert(`Synced ${result.result.synced} Jira issues!`);
    } catch (error) {
  ...
  const handleSyncNotion = async () => {
    ...
    try {
      const result = await syncNotion.mutateAsync(workspaceId);
      alert(`Synced ${result.result.synced} Notion pages!`);
    } catch (error) {
      alert("Sync failed: " + error.message);
    }
  };
            ...
            <div className="stat-card">
              ...
              <div className="stat-info">
                <span className="stat-value">
                  {stats.automationsRun.toLocaleString()}
                </span>
                ...
                {automations.map((automation) => (
                  <div key={automation.id} className="automation-item">
                    ...
                    <div className="automation-stats">
                      <span className="automation-runs">
